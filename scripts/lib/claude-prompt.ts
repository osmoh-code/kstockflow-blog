...
- 강조 표현 규칙 (매우 중요):
  - <mark> 태그는 절대 사용하지 마세요. 렌더링 시 밑줄/하이라이트가 생겨 가독성을 해칩니다.
  - 강조가 필요한 경우 **볼드(별표 두개)**만 사용하세요.
  - 볼드도 남용하지 마세요. 문단당 최대 1~2개만 사용하세요.
...
- <mark> 태그 절대 금지. 강조는 **볼드**만 사용 (문단당 최대 1~2개)
